<div class="m-6">
    <h2 class="mt-2 mb-9 text-3xl font-bold tracking-tight sm:text-4xl text-white">Create an account</h2>
    <form action="/register" method="post" >
        ...
        <a href="/user/login"><button type="button" class="ml-6 text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">Login</button></a>
    </form>
</div>